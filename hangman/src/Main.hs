...
instance Show Puzzle where 
  show (Puzzle _ discovered guessed) =
    (intersperse ' ' $ fmap renderPuzzleChar discovered) ++ " Guesses so far: " ++ guessed
...
alreadyGuessed (Puzzle word _ guessed) char = elem char guessed
